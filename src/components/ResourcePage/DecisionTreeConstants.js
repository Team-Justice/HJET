...
//LEGACY 
export const needHomeRenovationAnswer = {title: "Home Renovation", answer: "TBD need home renovation"};
export const wantToAttendWealthSeminarAnswer = {title: "Wealth Seminar", answer: "TBD wealth seminar"};
export const haveReverseMortgageAnswer =  {title: "Reverse Mortgage", answer: "TBD have Reverse Mortgage"};
export const needMortgageOrDeedTransferAnswer = {title: "Mortgage/Deed Transfer", answer: "TBD morgage or deed transfer"};
...
//MAINTAIN
export const needSignificantRepairsAnswer = {title:"Significant Repairs", answer: "TBD need significant repairs"};
export const needHealthyHomeAuditAnswer = {title: "Health Home Audit", answer: "TBD healthy home audit"};
export const needEnergyEfficiencyAuditAnswer = {title: "Energy Efficiency Audit", answer: "TBD energy efficiency"};
export const needRenovationResourcesAnswer = {title: "Renovation Resources", answer: "TBD renovation resources"};
export const needFinancingAssistanceAnswer = {title: "Financing Assistance", answer: "TBD need financing assistance"};
...
export const needEmploymentCounselingAnswer = {title: "Emploument Counseling", answer: "TBD need employment counseling"};
...
export const reverseMortgageAnswer = {title: "Reverse Mortgage", answer: "TBD reverse mortgage"};
